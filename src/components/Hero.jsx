import { Map, Calendar, Search, ChevronsDown } from 'lucide-react';
      ...
      <div className="relative text-center text-black max-w-4xl w-full md:w-1/2">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mx-auto">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <button className="bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 text-white px-6 py-2 rounded flex items-center justify-center">
